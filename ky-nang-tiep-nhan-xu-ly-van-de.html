...
<head>
    ...
    <title>Kỹ năng Tiếp nhận & Xử lý vấn đề triệt để</title>
    
    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Roboto:wght@400;600;700&family=Poppins:wght@400;600;700&family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
    ...
    <script type="text/babel">
        ...
        const Slide = ({ children, className = "" }) => (
            <div className={`slide-container ${className}`}>
                ...
                <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-blue-900/5 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="min-h-screen py-10">
                        ...
                        <div className="p-[60px] flex flex-col justify-center items-center relative z-10">
                            ...
                            <div className="mt-8">
                                <span className="bg-brand-orange text-white px-8 py-3 rounded-full font-bold text-lg flex items-center gap-3 w-fit mx-auto shadow-lg">
                                    <Icon name="graduation-cap" /> Learning and Development Department
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <Slide>
                        ...
                        <div className="grid grid-cols-3 gap-8 flex-grow items-stretch">
                            {[
                                { icon: "hand-metal", title: "Chủ động & Chia sẻ", desc: "Không có câu trả lời đúng hay sai, chỉ có cách giải quyết phù hợp trong từng tình huống." },
                                { icon: "rotate-ccw", title: "Thực hành & Phản hồi", desc: "Tích cực tham gia Roleplay. Đúc kết kinh nghiệm qua từng trải nghiệm thực tế cùng đồng nghiệp." },
                    ...
                    <Slide>
                        ...
                        <div className="flex-grow flex flex-col justify-center">
                            ...
                            <p className="text-center mt-32 font-bold text-brand-orange text-2xl flex items-center justify-center gap-2">
                                <Icon name="star" className="fill-brand-orange" /> Highlight: Bài học hôm nay đi sâu vào kỹ năng xử lý tại Bước 2.
                            </p>
                        </div>
                    </Slide>
                        ...
                        <div className="flex flex-col flex-grow justify-center max-w-3xl mx-auto w-full">
                            ...
                            <div className="bg-slate-50 p-8 rounded-xl border border-slate-200 shadow-sm">
                                <h3 className="text-2xl font-bold text-brand-orange mb-6 flex items-center justify-center gap-2">
                                    <Icon name="timer" /> Kỹ thuật 3-3-1
                                </h3>
                                <ul className="space-y-4 mb-8 max-w-md mx-auto">
                                    <li className="flex items-center gap-3 text-lg font-bold">
                                        <Icon name="arrow-right" className="text-brand-blue" /> Hít sâu 3 giây
                                    </li>
                                    <li className="flex items-center gap-3 text-lg font-bold">
                                        <Icon name="arrow-right" className="text-brand-blue" /> Thở chậm 3 giây
                                    </li>
                                    <li className="flex items-center gap-3 text-lg font-bold">
                                        <Icon name="arrow-right" className="text-brand-blue" /> Gọi tên 1 cảm xúc xuất hiện
                                    </li>
                                </ul>
                    ...
                    <Slide>
                        ...
                        <div className="grid grid-cols-3 gap-8 flex-grow">
                            {[
                                ...
                                { icon: "shield-check", title: "Có người CHỊU TRÁCH NHIỆM", desc: "Khách hàng cần một đại diện từ công ty nhận lỗi hoặc ghi nhận sự cố thay vì đùn đẩy trách nhiệm." },
                                ...
                                <div key={i} className="bg-slate-50 border border-slate-200 rounded-xl p-8 flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-xl font-bold text-brand-blue mb-4 leading-tight">
                                        {item.title.split(' ').map((word, idx) => ['HIỂU', 'CHỊU', 'TRÁCH', 'NHIỆM', 'XỬ', 'LÝ', 'CÙNG'].includes(word) ? <span key={idx} className="text-brand-orange">{word} </span> : word + ' ')}
                                    </h3>
                        ...
                        <div className="mt-10 bg-brand-blue p-6 rounded-xl text-center">
                            <p className="text-white text-3xl font-display font-bold flex items-center justify-center gap-4">
                                <Icon name="quote" className="text-brand-orange rotate-180" /> THẤU HIỂU TRƯỚC - GIẢI THÍCH SAU <Icon name="quote" className="text-brand-orange" />
                            </p>
                        </div>
                    </Slide>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        <p className="font-bold text-red-700 text-xl mb-4 flex items-center gap-2">
                                            <Icon name="circle-x" size={20} /> Tránh dùng:
                                        </p>
                                        <ul className="list-disc pl-8 italic text-slate-700 space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-12 flex-grow items-center">
                            <div className="space-y-6">
                                ...
                                <p className="font-bold text-green-800 text-center pt-4">
                                    <Icon name="key" className="inline text-brand-orange mr-2" /> Giải quyết được "Mối lo ngại" = Khách hàng hài lòng.
                                </p>
                            </div>
                    ...
                    <Slide>
                        ...
                        <div className="grid grid-cols-3 gap-8 flex-grow">
                            {[
                                ...
                                { icon: "message-square", title: "Từ khóa tương tác", desc: "Thể hiện bạn vẫn đang tập trung bằng các câu đệm ngắn gọn:\n\n\"Dạ em đang nghe\"\n\"Vâng, em vẫn đang ghi nhận ạ\"" },
                            ...
                            <div className="bg-blue-50 p-10 rounded-xl border border-blue-200 h-full flex flex-col justify-center">
                                <div className="mb-8">
                                    <p className="text-xl font-bold text-brand-blue mb-4 flex items-center gap-2">
                                        <Icon name="lightbulb" className="text-brand-orange" /> Mẹo ngắt lời lịch sự:
                                    </p>
                            ...
                            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-lg">
                                <thead>
                                    <tr className="bg-brand-blue text-white text-left">
                                        <th className="p-6 text-xl font-display font-bold w-1/4"><Icon name="layers" className="inline mr-2" /> Nhóm Vấn Đề</th>
                                        <th className="p-6 text-xl font-display font-bold"><Icon name="stethoscope" className="inline mr-2" /> Bảng Chẩn Đoán Nhanh & Dấu Hiệu</th>
                                    </tr>
                                </thead>
                    ...
                    <Slide>
                        ...
                        <div className="grid grid-cols-2 gap-12 flex-grow items-center">
                            <div>
                                ...
                                <div className="space-y-6">
                                    {[
                                        { icon: "message-square", title: "Nói ngôn ngữ của khách hàng", desc: "Chuyển đổi các thuật ngữ chuyên môn IT phức tạp thành từ ngữ thông dụng, dễ hiểu." },
                                        { icon: "list-ordered", title: "Chia nhỏ quy trình", desc: "Đừng đưa một lúc 5 bước. Hãy hướng dẫn: Bước 1 -> Bước 2." },
                                        { icon: "check-check", title: "Xác nhận từng nấc", desc: "Chỉ khi khách hàng xác nhận đã làm được bước A, mới tiếp tục hướng dẫn sang bước B." }
                                    ].map((item, i) => (
                                        <div key={i} className="bg-slate-50 p-6 rounded-xl border border-slate-200 flex gap-6">
                                            <div className="text-brand-orange shrink-0"><Icon name={item.icon} /></div>
                                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-8 flex-grow">
                            {[
                                ...
                                <div key={i} className="bg-slate-50 p-8 rounded-xl border border-slate-200 flex gap-6 items-start shadow-sm">
                                    <Icon name="circle-check" className="text-brand-orange shrink-0" size={40} />
                                    <div>
                        ...
                        <div className="flex-grow flex flex-col justify-center">
                            <div className="bg-slate-50 p-12 rounded-2xl border border-slate-200 shadow-lg relative">
                                <div className="absolute -top-6 left-12 bg-brand-orange text-white px-6 py-2 rounded-full font-bold flex items-center gap-2">
                                    <Icon name="building-2" size={20} /> Bối cảnh: Quản lý nhà hàng giờ cao điểm - App xoay mòng mòng - Không in được bill.
                                </div>
                                <blockquote className="text-2xl italic leading-relaxed text-slate-700 relative">
                                    <Icon name="quote" className="absolute -top-6 -left-8 text-brand-orange/20 w-16 h-16 rotate-180" />
                                    ...
                                    <Icon name="quote" className="absolute -bottom-6 -right-8 text-brand-orange/20 w-16 h-16" />
                                </blockquote>
                    ...
                    <Slide>
                        ...
                        <div className="grid grid-cols-3 gap-8 flex-grow">
                            {[
                                { num: "3", color: "text-brand-orange", label: "Điều Quan Trọng Nhất", desc: "Đã học được từ buổi đào tạo hôm nay về kỹ năng tiếp nhận & Xử lý vấn đề triệt để." },
                    ...
                    <div className="slide-container relative flex items-center justify-center">
                        <img 
                                ...
                                <ul className="grid grid-cols-2 gap-x-12 gap-y-4">
                                    {[
                                        ...
                                        <li key={i} className="text-indigo-100 text-2xl flex items-center gap-4">
                                            <Icon name="check" className="text-brand-orange" size={28} /> {item}
                                        </li>
                                    ))}
                                </ul>
                            </div>
